 ...
 * but the role is explicit (`super_admin` manages, `support` reads) and there is no password path —
 * operators always get the Cognito invite email (FORCE_CHANGE_PASSWORD).
 */
export const createPlatformUserSchema = z.object({
  ...
  phone: z
    ...
    .optional(),
  platformRole: z.enum(['super_admin', 'support']),
});
